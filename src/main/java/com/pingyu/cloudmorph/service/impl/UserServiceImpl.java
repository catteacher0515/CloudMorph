...
import com.pingyu.cloudmorph.model.enums.UserRoleEnum;
...
import static com.pingyu.cloudmorph.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public QueryWrapper getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        if (ObjUtil.isNotEmpty(userRole)) {
            queryWrapper.eq("userRole", userRole);
        }
        if (ObjUtil.isNotEmpty(userAccount)) {
            queryWrapper.like("userAccount", userAccount);
        }
        if (ObjUtil.isNotEmpty(userName)) {
            queryWrapper.like("userName", userName);
        }
        if (ObjUtil.isNotEmpty(userProfile)) {
            queryWrapper.like("userProfile", userProfile);
        }
        if (ObjUtil.isNotEmpty(sortField)) {
